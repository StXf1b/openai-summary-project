  ...
  return (
    <section className="mt-16 w-full max-w-xl">
      <div className="flex flex-col w-full gap-2">
        ...
        <div className="flex flex-col gap-1 max-h-60 overflow-y-auto">
          {allArticles.map((item, index) => (
            <div onClick={() => setArticle(item)} key={`link-${index}`} className="link_card">
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
        ...
        <p className="font-inter font-bold text-black text-center">We dont have anymore request avalible or there is been a serious error!{error?.data?.error}</p>)
         : (
          article.summary && (
